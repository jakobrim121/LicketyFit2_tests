...
def read_sim_data(file_path):
    ...
    sim_dict = {'true_hit_pmt':true_hit_pmt,'true_hit_time':true_hit_time,'digi_hit_pmt':digi_hit_pmt,
               ...
               'track_pid':track_pid, 'track_start_time':track_start_time, 'digi_hit_charge':digi_hit_charge, 'position':position, 'direction':direction, 'energy':energy, 'track_energy':track_energy, 'track_boundary_kes':track_boundary_kes}
